...
These instructions describe the original Python app and have not been revalidated for the C# release. For the current Windows app, see the [main README](../README.md).
...
The historical README claimed MIT licensing, but no LICENSE file was included in the repository. No new license is introduced by this release.
